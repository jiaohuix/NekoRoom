 ...
 *   <modelDir>/te.mnn ve.mnn dp.mnn vocoder.mnn
 *   <modelDir>/voices/catgirl_style.json
 ...
 *   tts.init("/sdcard/supertonic-neko/fp16", voiceId = "catgirl_style")
...
class SuperTonicInfer(private val context: Context) {
    ...
    fun init(
        ...
        jni.setModelPath(dp.absolutePath, te.absolutePath, ve.absolutePath, voc.absolutePath)
        initialized = true
        return true
    }
     ...
     */
    fun synth(text: String, seed: Int = 42, speed: Float = 1.0f): Pair<FloatArray?, Long> {
        ...
        val pcm = synchronized(synthLock) {
            ...
            jni.synth(
                ...
                r.textMask, styleTtl, styleDp, seed, speed,
            )
        }
